...
class ReActAgent(BaseAgent):
    ...
    async def act(self, decision: str) -> tuple[str, str, bool]:
        ...
        if action_match and action_input_match:
            ...
            try:
                ...
                if start != -1 and end != -1:
                    ...
                    return tool_name, f"Error: Action Input must be a valid JSON string. Got: {input_str}", False
        ...
        return "Unknown", "Error: Could not parse Action and Action Input from response.", False
    ...
    async def run(self, user_input: str) -> str:
        ...
        if not final_response:
            final_response = "I'm sorry, I couldn't complete the task within the maximum number of steps."
